	...
	<body>
		<div class="container-fluid">
				<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
					...
					<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
						<legend><h1>Daftar Pegawai</h1></legend>
								...
								<?php foreach ($pegawai_list as $key) { ?>
									<tr>
										...
										<td>
											...
											<a href="<?php echo site_url('pegawai/update/').$key->id ?>" type="button" class="btn btn-default">Update</a>
											<a href="<?php echo site_url('pegawai/delete/').$key->id ?>" onclick="return confirm('Anda yakin menghapus data?')" type="button"  class="btn btn-primary">Hapus</a>
